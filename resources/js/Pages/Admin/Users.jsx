                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gray-600 dark:text-gray-300 mt-3 text-lg">Manage user accounts and permissions</p>
                            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="text-2xl font-bold text-gray-900 dark:text-white">{users.data.filter(u => u.is_active).length}</span>
                            </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                            ...
                            <p className="text-sm font-medium text-gray-900 dark:text-white">Inactive Users</p>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="text-2xl font-bold text-gray-900 dark:text-white">{users.data.filter(u => u.role === 'admin').length}</span>
                            </div>
                            <p className="text-sm font-medium text-gray-900 dark:text-white">Admins</p>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="text-2xl font-bold text-gray-900 dark:text-white">{users.data.filter(u => u.role === 'user').length}</span>
                            </div>
                            <p className="text-sm font-medium text-gray-900 dark:text-white">Regular Users</p>
                            <p className="text-xs text-gray-500 dark:text-gray-400">Standard accounts</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-8 border border-gray-100 dark:border-gray-700">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center space-x-2">
                                ...
                                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Search & Filter Users</h2>
                            </div>
                            ...
                            <div className="flex-1">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-3 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl focus:border-purple-500 focus:ring-purple-500 focus:ring-2"
                                    />
                                </div>
                            </div>
                            <select
                                ...
                                className="border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl focus:border-purple-500 focus:ring-purple-500 focus:ring-2 px-4 py-3"
                            >
                    ...
                    {users.data.length > 0 ? (
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-12 text-center border border-gray-100 dark:border-gray-700">
                            <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-2xl w-20 h-20 mx-auto mb-6 flex items-center justify-center">
