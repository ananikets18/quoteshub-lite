...
import { User, AtSign, Mail, Lock, ArrowLeft, ArrowRight, Github, Chrome, Sparkles } from 'lucide-react';
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-xs">
                                <span className="px-4 py-1 bg-white dark:bg-gray-950 text-gray-500 font-medium">Or join with</span>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <a
                                ...
                                className="flex items-center justify-center gap-3 px-4 py-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-all font-medium text-gray-700 dark:text-gray-300 text-sm"
                            >
                            ...
                            <button
                                type="button"
                                className="flex items-center justify-center gap-3 px-4 py-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-all font-medium text-gray-700 dark:text-gray-300 text-sm opacity-50 cursor-not-allowed"
